...
import { FormSalidaNuevoMovimientoModalComponent } from './components/form-salida-nuevo-movimiento-modal/form-salida-nuevo-movimiento-modal.component';
import { FormIngresoNuevoMovimientoModalComponent } from './components/form-ingreso-nuevo-movimiento-modal/form-ingreso-nuevo-movimiento-modal.component';

const COMPONENTS: any[] = [
  MovementOfGoodsComponent,
  ListaGeneralComponent,
  FormSalidaNuevoMovimientoModalComponent,
  FormBwNuevoMovimientoModalComponent,
  FormIngresoNuevoMovimientoModalComponent,
];
