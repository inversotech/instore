...
import { FormBwUpdateMovimientoModalComponent } from '../form-bw-update-movimiento-modal/form-bw-update-movimiento-modal.component';
import { Location } from '@angular/common';

@Component({
  selector: 'open-movement-bw-main',
  templateUrl: './movement-bw-main.component.html',
  styleUrls: ['./movement-bw-main.component.scss']
})
export class MovementBwMainComponent implements OnInit, OnDestroy {
  ...
  public onUpdate() {
    ...
    const modal = this.nbDialogService.open(FormBwUpdateMovimientoModalComponent);
  ...
  public finalize() {
    ...
    this.movimientosService.finalizeBetweenWarehouses$(this.movimientoId, {})
      .pipe(map(res => res.data), finalize(() => this.loadingSave = false))
      .subscribe(response => {
        this.getMovimientoDetalle();
        this.cleanFormDetalle();
