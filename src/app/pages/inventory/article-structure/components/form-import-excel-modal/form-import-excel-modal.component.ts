...
@Component({
  selector: 'open-form-import-excel-modal',
  templateUrl: './form-import-excel-modal.component.html',
  styleUrls: ['./form-import-excel-modal.component.scss']
})
export class FormImportExcelModalComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private dialogRef: NbDialogRef<FormImportExcelModalComponent>,
  ...
  public onSave() {
    ...
    if (this.filesExcels.length === 1) {
      ...
      this.articulosService.addImport$(formData)
