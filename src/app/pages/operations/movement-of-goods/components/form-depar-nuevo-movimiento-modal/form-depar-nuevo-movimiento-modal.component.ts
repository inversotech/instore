...
@Component({
  selector: 'open-form-depar-nuevo-movimiento-modal',
  templateUrl: './form-depar-nuevo-movimiento-modal.component.html',
  styleUrls: ['./form-depar-nuevo-movimiento-modal.component.scss']
})
export class FormDeparNuevoMovimientoModalComponent implements OnInit, OnDestroy {
  ...
  constructor(private dialogRef: NbDialogRef<FormDeparNuevoMovimientoModalComponent>,
