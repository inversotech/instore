...
import { ReceiMovementsRoutingModule } from './recei-movements-routing.module';
import { InfoProveedorModalModule } from 'src/app/pages/shared/info-proveedor-modal';

const COMPONENTS: any[] = [
  ReceiMovementsComponent,
...
export class ReceiMovementsModule { }
