...
// import { CODIGO_OPERACION_VENTA } from 'src/app/pages/electronic-billing/quotation-issuance/components/enum';
// import { PriceQuotesService, YearsService, MonthsService, BillingIssuanceService } from 'src/app/providers/services';
// import { IssuanceQuotationService } from 'src/app/providers/services/electronic-billing/issuance-quotation.service';
// import { SalesService } from 'src/app/providers/services/electronic-billing/sales.service';
// import { FacturacionService } from 'src/app/providers/services/facturacion/facturacion.service';
// import { UserService } from 'src/app/providers/services/person/user.service';
// import { ConfirmModalComponent } from 'src/app/shared/confirm-modal';
// import { FormSendMailModalComponent } from 'src/app/shared/form-send-mail-modal/form-send-mail-modal.component';
// import { RemissionGuideModalComponent } from 'src/app/shared/remission-guide-modal/remission-guide-modal.component';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'lamb-main-sales',
...
export class MainSalesComponent implements OnInit, OnDestroy {
  ...
  private getVentas(): void {
    ...
    this.loading = true;
    this.salesService.getSalesFinalized$(params)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: res => {
          this.loading = false;
  ...
  public anularVenta(item: any) {
    if (!confirm('¿Estás seguro de anular la venta?')) return;
    this.loading = true;
    this.salesService.anularSale$(item.id_venta)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: () => {
          this.loading = false;
