...
export class UsersService extends EntityDataService<any>{
    ...
    constructor(protected override httpClient: HttpClient) {
        super(httpClient, `${environment.apiUrls.openAccounting}/api/users`);
    }
    ...
    public getRolsById$(id: any, params: any): Observable<any> {
        return this.httpClient.get<any>(`${this.endPoint}/${id}/rols`, { params: params });
    }
