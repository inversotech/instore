...
export class SalesQuickService extends EntityDataService<any> {
    constructor(protected override httpClient: HttpClient) {
        super(httpClient, `${environment.apiUrls.openAccounting}/api/sales/sales-quick`);
    }


    public getSearchArticuloToVenta$(params: any): Observable<any> {
        return this.httpClient.get<any>(`${this.endPoint}/search-articulo-to-venta`, { params: params });
    }

    public getPuntoVentaById$(idPuntoVenta: any): Observable<any> {
        return this.httpClient.get<any>(`${this.endPoint}/punto-ventas/${idPuntoVenta}`);
    }
