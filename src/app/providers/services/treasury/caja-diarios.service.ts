...
export class CajaDiariosService extends EntityDataService<any> {
    constructor(protected override httpClient: HttpClient) {
        super(httpClient, `${environment.apiUrls.openAccounting}/api/incomes/caja-diarios`);
    }
    ...
    public getCajasDisponibles$(params: any): Observable<any> {
        return this.httpClient.get<any>(`${this.endPoint}/cajas-disponibles`, { params: params });
    }

    public openCajaDiario$(data: any): Observable<any> {
        return this.httpClient.post<any>(`${this.endPoint}/open`, data);
    }

    public closeCajaDiario$(id_caja_diario: any, data: any): Observable<any> {
